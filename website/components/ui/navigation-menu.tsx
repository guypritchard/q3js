...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <CaretDownIcon className="ml-1 size-3 self-center transition duration-300 group-data-popup-open/navigation-menu-trigger:rotate-180 group-data-open/navigation-menu-trigger:rotate-180" aria-hidden="true" />
    </NavigationMenuPrimitive.Trigger>
  )
}
